...
class Appart_products extends Widget_Base {
    ...
    public function get_name() {
        return 'appart_products';
    }

    public function get_title() {
        return __( 'Products (Grid View)', 'appart-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'excerpt', [
                'label' => esc_html__( 'Excerpt Limit', 'chaoz-core' ),
                'type' => Controls_Manager::NUMBER,
                'label_block' => true,
                'default' => 7
            ]
                    ...
                    while($query->have_posts()) : $query->the_post(); ?>
                        <div <?php wc_product_class('col-lg-3 col-md-4 col-sm-6') ?>>
                            <div class="tr_product_item">
                                <?php the_post_thumbnail('appart_350x360', array('class'=>'img-fluid')) ?>
