...
class Appart_testimonials extends Widget_Base {
	...
	public function get_name() {
		return 'appart-testimonials';
	}

	public function get_title() {
		return __( 'Testimonials', 'appart-hero' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
                'testimonial_sec', [
                    'label' => __( 'Testimonial items', 'appart-core' ),
			]
		);
		$this->add_control(
			'testimonials', [
				'label' => __( 'Testimonials', 'appart-core' ),
				'type' => Controls_Manager::REPEATER,
				'title_field' => '{{{ author_name }}}',
				'fields' => [
					[
						'name' => 'author_name',
						'label' => esc_html__('Quote Author Name', 'appart-core'),
						'type' => Controls_Manager::TEXT,
						'default' => 'Eh Jewel',
					],
					[
						'name' => 'author_url',
						'type' =>  Controls_Manager::TEXT,
						'label' => esc_html__('Quote Author URL', 'appart-core'),
						'default' => '#',
					],
					[
						'name' => 'author_designation',
						'type' => Controls_Manager::TEXT,
						'label' => esc_html__('Author Designation', 'appart-core'),
						'default' => 'Programmer @ DroitLab'
					],
					[
						'name' => 'quote',
						'type' => Controls_Manager::TEXTAREA,
						'label' => esc_html__('Quote Text', 'appart-core'),
					...
					[
						...
						'label' => esc_html__('Quote Author image', 'appart-core'),
					],
				],
			]
		);
                            ...
                            foreach ($quotes as $quote) {
                                ...
                                <div class="carousel-item <?php if($count === 1){echo esc_attr('active');}?>">
                                    <div class="carousel_text">
                                        <img src="<?php echo plugin_dir_url(__FILE__).'images/quote2.png'; ?>" alt="f_img">
                            ...
                            <div class="slick testimonial_slider_five">
                                ...
                                foreach ($quotes as $quote) {
                                    ...
                                    <div class="testimonial-content flex">
                                        <img class="quote" src="<?php echo plugin_dir_url(__FILE__).'images/quote3.png'; ?>" alt="<?php esc_attr_e('quot icon', 'appart') ?>">
                                        <?php if(!empty($quote['quote'])) : ?>
                                            <p>“<?php echo $quote['quote']; ?>”</p>
                                        <?php endif; ?>
